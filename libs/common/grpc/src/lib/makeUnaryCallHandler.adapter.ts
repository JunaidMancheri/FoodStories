...
import { BaseHandler, HandlerType, RequestPayload } from "@food-stories/common/handlers";
...
export function makeUnaryCallHandler(handler: BaseHandler, logger: ILogger):  handleUnaryCall<any, any> {
